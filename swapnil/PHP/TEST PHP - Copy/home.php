	...
	<section class="sufia-slider clearfix">
			<div class="carousel-inner">
				<div class="item active">
					<img src="assets/images/slider-bg1.jpg" alt="Slider Image 1">
				...
				<div class="item">
					<img src="assets/images/slider-bg2.jpg" alt="Slider Image 2">
					<div class="carousel-caption">
						<h1>We Provide<br>Perfect Pixel Coding!</h1>
						<a class="btn learn-more" href="#">Learn More</a>
						<a class="btn buy-now" href="#">Buy Now</a>
				 ...
				 <div class="item">
					<img src="assets/images/slider-bg3.jpg" alt="Slider Image 3">
					<div class="carousel-caption">
						<h1>We Provide<br>Perfect Pixel Coding!</h1>
						<a class="btn learn-more" href="#">Learn More</a>
						<a class="btn buy-now" href="#">Buy Now</a>
